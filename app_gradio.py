...
model = BertForSequenceClassification.from_pretrained("./src/feedback_model",local_files_only=True)
tokenizer = BertTokenizer.from_pretrained("./src/feedback_model",local_files_only=True)
